...
export function SignInPage({ onNavigate }: SignInPageProps) {
  return (
    <section className="min-h-screen flex items-center justify-center py-20 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-80 h-80 bg-accent/15 rounded-full blur-3xl"></div>
          ...
          <Card className="border border-primary/20 bg-card/95 backdrop-blur-xl shadow-2xl shadow-primary/10">
            ...
            <CardHeader className="text-center space-y-2 pb-6">
              ...
              <CardDescription className="text-muted-foreground">
                Sign in to your Foresight account
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <Button className="w-full bg-gradient-to-r from-primary to-accent hover:shadow-lg hover:shadow-primary/30" size="lg">
                Sign In
              </Button>
